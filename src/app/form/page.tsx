...
const FormPage = () => {
  ...
  console.log(categoryFormTagList);
  ...
  const submitForm = async () => {
    try {
      ...
      // const { data, error } = await supabase.from("placeReview").insert([
      //   {
      //     content,
      //     date: selectedDate.toISOString(),
      //     image_urls: uploadedImageUrls // 이미지 파일의 URL 배열을 저장
      //   }
      // ]);
      ...
      // } else {
      //   console.log("데이터가 성공적으로 삽입되었습니다:", data);
      // }
    } catch (error) {
  ...
  return (
    <div className="container m-auto">
      ...
      <Button value="제출" onClick={submitForm} />
    </div>
  );
};
